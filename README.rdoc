...
- Instantiate sub-templates on the fly, passing data as arguments
    ...
    <<+{my_sub_template.whtml using who: 'blambeau'}
...
- Generate a wlang template and instantiate it after that
    ...
    tpl = "Hello $(${varname})!".wlang(:varname => 'who')             # => Hello $(varname)!
    tpl.wlang({:who => 'wlang'}, 'wlang/active-string', :parentheses) # => Hello wlang!
